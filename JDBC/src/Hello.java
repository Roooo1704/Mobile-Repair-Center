		...
		try {
			...
			while (true) {
				...
				case 1: {
					...
					String query1 = "INSERT INTO `first`(`token`, `name`, `mobile`,`model`, `date`, `descrip`) VALUES ("
							+ token + ",'" + name + "'," + no + ",'" + mo + "','" + dateForm.format(thisDate) + "','"
							+ prob + "')";
				...
				case 3: {
					...
					ResultSet resultSet = statement
							.executeQuery("select * from `first` where `date` between '" + s + "' and '" + e + "' ");
